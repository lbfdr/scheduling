...
public class AES {
    ...
    public static String parseByte2HexStr(byte buf[]) {
        ...
        for (int i = 0; i < buf.length; i++) {
            String hex = Integer.toHexString(buf[i] & 0xFF);//0xFF = 255
            if (hex.length() == 1) {
                hex = '0' + hex;
            }
    ...
    public static void main(String[] args) throws IOException, ParseException{
        ...
        System.out.println(DateUtil.crutDate() + " " + "08:00:00");
//        String loginName = encode("{\n" +
//                "  \"loginName\": \"lvguoming\",\n" +
//                "  \"longinTokenId\": \"53598478b15b42f984f778b9b9141a28\"\n" +
//                "}");
        String loginName = encode("{\n" +
                "  \"loginName\": \"wangdi\",\n" +
                "  \"longinTokenId\": \"0cd5ac6f494e4894a7fd699217888b70\"\n" +
                "  \"scenicSpotId\": \"15698320289682\"\n"+
                "   \"robotRunState\": \"15698320289682\"\n"+
                "}");
