...
public class DateUtil {
    ...
    public static final int C_ONE_SECOND = 1000;//1秒
    public static final int C_ONE_MINUTE = 60 * C_ONE_SECOND;//1分钟
    public static final long C_ONE_HOUR = 60 * C_ONE_MINUTE;//1小时
    public static final long C_ONE_DAY = 24 * C_ONE_HOUR;//1天

    public static final String DAYBEGIN = "00:00:00";
    public static final String DAYEND = "23:59:59";

    /**
     * 返回当前日期的字符串形式，格式为yyyy-MM-dd HH:mm:ss
     * @return
     */
    ...
    /**
     *
     * @return 返回格式化之后的当前日期的字符串，格式为yyyy-MM-dd
     */
    ...
    **/
    ...
    public static boolean getWeekend() {
        ...
        cal.setTime(new Date());//使用给定的Date设置此日历的时间
    ...
    public static Date localDate2Date(LocalDate localDate) {
        ...
        return Date.from(zonedDateTime.toInstant());//从Instant对象获取Date的实例
    }

    /**
     * 根据开始时间和结束时间得到使用时长(单位/分钟)
     * @param startTime
     * @param endTime
     * @return
     * @throws Exception
    ...
    public static long timeConversion(String startTime,String endTime) throws ParseException {
        Date parse = StringToDateTime(startTime);//将String类型的日期时间转换成java.util.Date类型的数据
        Date d = StringToDateTime(endTime);
        //getTime()返回此Date对象表示的自 1970 年 1 月 1 日 00:00:00 GMT 以来的毫秒数
        long time1 = (d.getTime() - parse.getTime());
        long times =  time1 / 1000 / 60;
        return times;
    }
    ...
    * @throws
    ...
    public static int caculateTotalTime(String startTime,String endTime) throws ParseException{
		...
		Date date1=null;
        //parse()从给定字符串的开头解析文本以生成日期。该方法可能不会使用给定字符串的整个文本
...
//        System.out.println(calcLastMonth("2021-12"));
        //System.out.println(getLastYearCurrentDate("2023-01"));
//        System.out.println(dateHoursList(new Date()));

        //System.out.println(strings.get(1));
        //System.out.println(findDates("2021-03-01","2021-04-01"));
        System.out.println(findDates("2021-01-01","2021-03-30"));
